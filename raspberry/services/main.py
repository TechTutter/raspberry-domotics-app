...
import time
import Adafruit_DHT
from api.routes.gpio_routes import gpio_bp
from api.routes.sensor_routes import sensor_bp
...
def checkToken(token):
    ...
    resp = requests.post('http://example.com/api/tokenIsValid', data = tokendata)
